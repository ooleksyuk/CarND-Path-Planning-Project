...
int main() {
  ...
  vector< vector<double> > X_train = Load_State("../prediction_data/train_states.txt");
  vector< vector<double> > X_test  = Load_State("../prediction_data/test_states.txt");
  vector< string > Y_train  = Load_Label("../prediction_data/train_labels.txt");
  vector< string > Y_test   = Load_Label("../prediction_data/test_labels.txt");
